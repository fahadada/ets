...
div.relative {
  ...
  <div class="relative">
<ol>
   <output type="text" name="type"  > <?php echo $rows["title"];?> :النوع<br>
   <br>
  <output type="text" name="place"> <?php   echo $rows["Place"];?>  :المكان  <br>
  <br>
  <output type="text" name="info"> <?php  echo $rows["Details"];?> :معلومات إضافية  <br>
  <br>
  <input type="submit" value="قبول" name="accept" />
<input type="submit" value="رفض" name="reject" />
  </ol>
</div>
	<?php	   
		   }
